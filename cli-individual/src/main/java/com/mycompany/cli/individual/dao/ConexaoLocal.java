...
public class ConexaoLocal {
    ...
    public ConexaoLocal() {
        ...
        dataSource.setUrl("jdbc:mysql://CliBD:3306/BancoLocalCli?autoReconnect=true&useSSL=false"); // trocar o localhost:3306 pelo endereço do banco e o tecflix pelo nome do banco
