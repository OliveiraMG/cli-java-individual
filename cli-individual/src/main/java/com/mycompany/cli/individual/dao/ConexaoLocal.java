...
public class ConexaoLocal {
    ...
    public ConexaoLocal() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3309/BancoLocalCli?autoReconnect=true&useSSL=falsex"); // trocar o localhost:3306 pelo endereço do banco e o tecflix pelo nome do banco
